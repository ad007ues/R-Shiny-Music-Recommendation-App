...
#   })
  ...
  #output$song_attributes <- renderDataTable(minfoFilter)

  #UIProducerinput <- as.numeric(c(input$acousticness,input$danceability, input$speechiness, input$energy, input$liveness,  input$Region))
  
  ##sampleTableoutput
  #paramterize user_id and className here
  # df1<- sqldf("select song_title,artist,pred_score2_final
  #     from song_usr_data 
